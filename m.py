...
def main():
    ...
    wav.write('sin440HzScaledInterpolatedLinearly.wav', sample_rate, output.astype(np.float32))
...
def main2():
    ...
    wav.write('sawtooth220HzScaledInterpolatedLinearly.wav', sample_rate, output.astype(np.float32))
